...
struct ExtensionDetailScreen: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text(MR.strings.browseUninstallConfirm)
        }
        .confirmationDialog(
        ...
        .alert(MR.strings.extensionRefreshFailed, isPresented: $showReinstallError) {
            Button(MR.strings.commonOk, role: .cancel) {}
        } message: {
    ...
    private var sourcesSection: some View {
        Section {
            if extensionSources.isEmpty {
                Text(MR.strings.extensionNoSources)
                    .foregroundStyle(.secondary)
                    .font(.subheadline)
            } else {
            ...
            Text(MR.strings.extensionSourcesFooter)
        }
    }
        ...
        Section {
            Button {
                ...
                HStack {
                    ...
                    Text(MR.strings.extensionForceRefresh)
                    Spacer()
                    if isReinstalling {
                        ProgressView()
                    }
            ...
            Text(MR.strings.extensionActions)
        } footer: {
            Text(MR.strings.extensionForceRefreshDesc)
        }
    }
    ...
    private var dangerSection: some View {
        Section {
            ...
            Text(MR.strings.extensionDangerZone)
        }
    }
