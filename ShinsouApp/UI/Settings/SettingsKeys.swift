...
enum SettingsKeys {
    ...
    static let volumeKeys                = "settings.reader.volumeKeys"
    ...
    static let proxyEnabled              = "settings.advanced.proxyEnabled"
    static let proxyWorkerUrl            = "settings.advanced.proxyWorkerUrl"
    static let proxyApiKey               = "settings.advanced.proxyApiKey"
}
