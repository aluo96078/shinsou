...
public final class LanguageManager: @unchecked Sendable {
    ...
    public static let languageDidChangeNotification = Notification.Name("MihonLanguageDidChange")
...
public enum MR {
    public enum strings {
        ...
        public static var aboutGithub: String { L("about_github") }
        public static var aboutGithubDesc: String { L("about_github_desc") }
        public static var aboutDiscord: String { L("about_discord") }
        public static var aboutDiscordDesc: String { L("about_discord_desc") }
        public static var aboutHelp: String { L("about_help") }
        public static var aboutDocs: String { L("about_docs") }
        public static var aboutReportIssue: String { L("about_report_issue") }
        public static var aboutLegal: String { L("about_legal") }
        public static var aboutLicenses: String { L("about_licenses") }
        public static var aboutPrivacy: String { L("about_privacy") }
